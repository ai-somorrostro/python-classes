...
class OpR_Client:
    ...
    def __generar_requests(self, data, opcion: int):
    ...
    def llamada_LLM_normal(self, prompt, modelo: str):
        """
    ...
    def llamada_modelo_razonador(self, prompt, modelo: str):
        """
    ...
    def llamada_img_gen(self, prompt, modelo: str):
        """
